<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MenuCustomControl.ascx.cs" Inherits="eLearn.admin.CustomUserControls.MenuCustomControl" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="person">My Profile</a></li>
                            </ul>
                        </li>
                        <li class="dropdown active">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Icons <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li class="active"><a href="icons" target="_blank">My Icons</a></li>
                            </ul>
                        </li>
                    </ul>
                      ...
                      <%--  <li class="dropdown notifications updates">
                            ...
                            <ul class="dropdown-menu" role="notification">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-left">
                                        <asp:Image runat="server" ImageUrl="~/images/people/50/guy-2.jpg" CssClass="width-30 img-circle" AlternateText="people" />
                                    </div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-left">
                                        <asp:Image runat="server" ImageUrl="~/images/people/50/guy-6.jpg" CssClass="width-30 img-circle" AlternateText="people" />
                                    </div>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a href="">
                                            <asp:Image runat="server" ImageUrl="~/images/people/50/woman-6.jpg" CssClass="width-30 img-circle" AlternateText="people" />
                                        </a>
                                        <a href="">
                                            <asp:Image runat="server" ImageUrl="~/images/people/50/woman-3.jpg" CssClass="width-30 img-circle" AlternateText="people" />
                                        </a>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle user" data-toggle="dropdown">
                                <asp:Image ID="imguser" runat="server" ImageUrl="~/images/people/110/guy-5.jpg" CssClass="width-40 img-circle" /> <asp:Literal ID="lblusername" runat="server"></asp:Literal> <span class="caret"></span>
                            </a>
